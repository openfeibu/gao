        ...
        <div class="layui-col-md12">
            <div class="tabel-message">
                <div class="layui-inline tabel-btn mb10">
                    <button class="layui-btn layui-btn-warm "><a href="{{guard_url('order/create')}}">添加单</a></button>
...
<script type="text/html" id="barDemo">
    <a class="layui-btn layui-btn-sm" href="{{ guard_url('order') }}/@{{ d.id }}?type=show" target="_blank">查看</a>
